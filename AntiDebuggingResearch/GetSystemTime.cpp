...
Timing::GetSystemTimeTest::GetSystemTimeTest()
{
	lf = LogFile("getsystemtime.log", "Timing", "GetSystemTime");
}

void Timing::GetSystemTimeTest::RunTest()
{
	//Initialize Buffer
	...
	for (size_t i = 0; i < LOOPSIZE; i++)
	{
		...
		if (_isDebugged())
		{
			std::cout << "[GetSystemTimeTest] Debugger detected. Exiting.\n" << std::endl;
			return;
		}
